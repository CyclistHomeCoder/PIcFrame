...
parse.add_argument(      "--use_dir_name",  default=False, type=str_to_bool, help="use directory name instead of file name, need show_name_tm > 0")
parse.add_argument(      "--skip_dir",      default="", help="skip directories with this name")
...
CODEPOINTS = '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZÅÄÖ., _-/ ' # limit to 49 ie 7x7 grid_size
