...
parse.add_argument("-i", "--no_files_img",  default="PIcFrame.jpg", help="image to show if none selected")
...
parse.add_argument("-v", "--time_delay",    default=20.0, type=float, help="time between consecutive slide starts - can be changed by MQTT")
